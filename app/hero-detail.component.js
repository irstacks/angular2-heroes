        ...
        execute: function() {
            HeroDetailComponent = (function () {
                ...
                HeroDetailComponent.prototype.ngOnInit = function () {
                    ...
                    var id = +this._routeParams.get('id'); // The hero id is a number. Route parameters are always strings. So we convert the route parameter value to a number with the JavaScript (+) operator.
